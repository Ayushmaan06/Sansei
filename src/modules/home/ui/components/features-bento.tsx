    ...
    <section className="py-16 md:py-24 dark:bg-transparent">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto mb-12 max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">Sansei is packed with features designed to help you build and deploy Next.js applications faster than ever before.</p>
        </div>
            ...
            <CardContent className="flex h-full flex-col justify-between p-6">
              <div className="h-full min-h-[150px] w-full rounded-lg bg-muted/30 p-4 font-mono text-xs">
                ...
                <div className="mt-4">
                  ...
                  <p className="opacity-70">&gt; Sansei@0.1.0 deploy /Users/Sansei/app</p>
                  ...
                  <div className="relative mt-1 opacity-0 transition-opacity delay-1000 duration-300 group-hover:opacity-100">
                    ...
                    <p className="truncate">  <span className="text-primary">&gt;</span> https://Sansei-proj-a7b3f.e2b.dev</p>
                  </div>
                </div>
              </div>
              <div className="mt-6">
