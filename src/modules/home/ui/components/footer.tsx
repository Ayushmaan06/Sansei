  ...
  const socialLinks = [
    {
      name: "GitHub",
      icon: FaGithub,
      href: "https://github.com/Ayushmaan06",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    {
      name: "LinkedIn",
      icon: FaLinkedin,
      href: "https://www.linkedin.com/in/ayushmaan03/",
      color: "hover:text-blue-600"
    },
    {
      name: "X",
      icon: FaXTwitter,
      href: "https://x.com/Ayushmaan0369",
      color: "hover:text-gray-900 dark:hover:text-gray-100"
    },
    // {
    //   name: "YouTube",
    ...
    //   name: "Spotify",
    //   icon: FaSpotify,
    //   href: "https://spotify.com/Ayushmaan06",
    ...
    <footer className="bg-background border-t border-border mt-16">
      <div className="max-w-7xl mx-auto px-8 py-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="flex items-center gap-3">
              <Image 
                ...
                className="w-7 h-7"
              />
              <h3 className="text-xl font-bold text-foreground">Sansei</h3>
            </div>
          ...
          <div>
            <a 
              href="mailto:s.ayushmaan06@gmail.com"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mt-8 pt-6 border-t border-border">
          <p className="text-sm text-muted-foreground">
            © 2025 Sansei. All rights reserved.
          </p>
