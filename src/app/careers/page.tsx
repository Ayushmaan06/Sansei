...
const roles: Role[] = [
  {
    ...
    type: "Full-time",
    location: "Remote",
    description: "We're looking for an AI wizard who can make machines think, learn, and create. Not someone who follows tutorials, but someone who writes them. You'll be building the core AI systems that power Sansei's code generation capabilities.",
    requirements: [
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20 p-8 rounded-2xl">
            ...
            <a
              href="mailto:s.ayushmaan06@gmail.com?subject=Application for [Role Name]"
          ...
          <div className="bg-background border border-border rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="bg-primary/10 border border-primary/20 p-6 rounded-xl text-center">
                ...
                <a
                  href={`mailto:s.ayushmaan06@gmail.com?subject=Application for ${selectedRole.title}&body=Hi ayushmaan,%0D%0A%0D%0AI'm interested in the ${selectedRole.title} position at Sansei.%0D%0A%0D%0A[Tell us about yourself and why you're perfect for this role]%0D%0A%0D%0ABest regards`}
