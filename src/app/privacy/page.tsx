            ...
            <div className="bg-background border border-border rounded-xl shadow-sm p-12">
              ...
              <div className="mb-12 p-6 bg-muted/30 border-l-4 border-primary">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  This Privacy Policy explains how Sansei collects, uses, and protects your personal information 
              ...
              <section id="overview" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    At Sansei, we believe privacy is a fundamental right. This policy describes how we collect, 
                    use, store, and protect your personal information when you use our service.
                  </p>
                  <p>
                    This policy applies to all users of the Sansei platform. By using our service, you consent 
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <ul className="list-none space-y-3 ml-2">
                    <li className="border-l-2 border-muted pl-3">
                      <span className="font-semibold text-foreground">Service Provision:</span> To provide and operate the Sansei platform
                    </li>
                    <li className="border-l-2 border-muted pl-3">
              ...
              <section id="user-rights" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>To exercise these rights, contact us at s.ayushmaan06@gmail.com</p>
                </div>
              </section>
                  ...
                  <div className="border-l-4 border-primary pl-4 py-3">
                    <div className="space-y-2">
                      <div className="border-l-2 border-muted pl-3">
                        <span className="font-semibold">Email:</span> s.ayushmaan06@gmail.com
                      </div>
                      <div className="border-l-2 border-muted pl-3">
                        <span className="font-semibold">Data Protection Officer:</span> s.ayushmaan06@gmail.com
                      </div>
                    </div>
                  </div>
                </div>
