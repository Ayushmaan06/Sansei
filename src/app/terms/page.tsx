          ...
          <div className="flex-1 max-w-4xl">
            <div className="bg-background border border-border rounded-2xl shadow-lg p-12 prose prose-gray dark:prose-invert max-w-none">
              ...
              <div className="mb-12 p-6 bg-primary/5 border border-primary/20 rounded-xl">
                <h2 className="text-xl font-semibold text-foreground mb-3">Welcome to Sansei</h2>
                <p className="text-muted-foreground leading-relaxed">
                  These Terms of Service ("Terms") govern your use of Sansei, an AI-powered platform for generating Next.js applications. 
              ...
              <section id="acceptance" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    By creating an account, accessing, or using Sansei's services, you acknowledge that you have read, 
                  ...
                  <p>
                    These Terms constitute a legally binding agreement between you ("User" or "you") and Sansei 
              ...
              <section id="description" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Sansei is an artificial intelligence-powered platform that enables users to generate Next.js 
              ...
              <section id="registration" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    To access certain features of Sansei, you must create an account. During registration, you agree to:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
              ...
              <section id="usage" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    You agree to use Sansei only for lawful purposes and in accordance with these Terms. 
              ...
              <section id="ai-services" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Sansei's AI service generates code based on your prompts and requirements. Important considerations 
              ...
              <section id="intellectual-property" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    The Sansei platform, including its AI models, algorithms, user interface, and underlying 
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>All rights in the Sansei platform and technology</li>
              ...
              <section id="user-content" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    You retain ownership of all original content, prompts, and data you provide to Sansei. 
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 p-4 rounded-xl">
                    ...
                    <p className="text-blue-600 dark:text-blue-300">
                      You grant Sansei a worldwide, non-exclusive, royalty-free license to use, process, 
              ...
              <section id="payments" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    Sansei offers both free and premium subscription tiers. Premium features require a paid subscription 
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 p-4 rounded-xl">
                    ...
                    <p className="text-red-600 dark:text-red-300 text-sm">
                      IN NO EVENT SHALL Sansei BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, 
              ...
              <section id="indemnification" className="mb-12 scroll-mt-8">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    You agree to indemnify, defend, and hold harmless Sansei, its officers, directors, employees, 
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <div className="bg-primary/5 border border-primary/20 p-6 rounded-xl">
                    ...
                    <div className="space-y-2">
                      <p><strong>Email:</strong> s.ayushmaan06@gmail.com</p>
                      <p><strong>Support:</strong> s.ayushmaan06@gmail.com</p>
