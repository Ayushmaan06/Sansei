...
const Page = () => {
  ...
  const socialLinks = [
    { name: "Email", icon: CiMail, href: "mailto:Ayushmaan06@gmail.com", color: "hover:text-blue-600" },
    { name: "GitHub", icon: FaGithub, href: "https://github.com/Ayushmaan06", color: "hover:text-gray-900 dark:hover:text-gray-100" },
    { name: "X", icon: FaXTwitter, href: "https://x.com/Ayushmaan06", color: "hover:text-gray-900 dark:hover:text-gray-100" },
    { name: "LinkedIn", icon: FaLinkedin, href: "https://linkedin.com/in/Ayushmaan06", color: "hover:text-blue-600" },
    { name: "Kaggle", icon: FaKaggle, href: "https://kaggle.com/Ayushmaan06", color: "hover:text-blue-500" },
    { name: "LeetCode", icon: SiLeetcode, href: "https://leetcode.com/Ayushmaan06", color: "hover:text-orange-500" },
    { name: "YouTube", icon: FaYoutube, href: "https://youtube.com/@vedthetank", color: "hover:text-red-600" },
    { name: "Spotify", icon: FaSpotify, href: "https://spotify.com/user/Ayushmaan06", color: "hover:text-green-500" },
    { name: "Medium", icon: FaMedium, href: "https://medium.com/@Ayushmaan06", color: "hover:text-gray-900 dark:hover:text-gray-100" }
  ];
      ...
      <div className="max-w-4xl mx-auto px-8 py-16">
        ...
        <div className="bg-background border border-border rounded-2xl p-12 shadow-lg">
          ...
          <div className="space-y-8 mb-12">
            ...
            <div className="border-l-4 border-primary pl-6 py-2">
              <p className="text-lg leading-relaxed text-muted-foreground">
                This is my story so far. From nothing, I'm <span className="text-foreground font-semibold">building</span>. From nowhere, I'm aiming everywhere. And Sansei is only the beginning.
              </p>
            </div>
          </div>
