    ...
    <div className="flex flex-col max-w-5xl mx-auto w-full px-4">
      <section className="space-y-16 pt-[16vh] 2xl:pt-48 pb-24">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-foreground/60">
            Need something custom? <a href="mailto:s.ayushmaan06@gmail.com" target="_blank" rel="noopener noreferrer"><span className="text-primary cursor-pointer hover:underline">Contact sales</span></a>
          </p>
        </div>
      </section>
    </div>
